    ...
    <div>
      ...
      <div className="md:hidden space-y-2">
        {products.length === 0 ? (
          ...
          return (
            <div key={p.id} className={`bg-white dark:bg-slate-800 rounded-xl border px-4 py-3 ${!p.isActive ? "opacity-60 border-slate-200 dark:border-slate-700" : isLow ? "border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/40" : "border-slate-200 dark:border-slate-700"}`}>
              {/* Row 1: name + status */}
            ...
            <tbody>
              {products.length === 0 ? (
                ...
                const rowBg = !p.isActive
                  ...
                  : isLow
                  ? "bg-red-50 dark:bg-red-950/40 hover:bg-red-50 dark:hover:bg-red-950/40"
                  : "hover:bg-slate-50";
                return (
                  <tr key={p.id} className={`border-t border-slate-100 ${rowBg}`}>
                    ...
                    <td className="px-4 py-2.5 text-right">
                      <div className={`font-semibold text-sm ${!p.isActive ? "text-slate-400" : isLow ? "text-red-600 dark:text-red-400" : "text-slate-800 dark:text-slate-100"}`}>
