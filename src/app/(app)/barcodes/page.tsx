...
export default async function BarcodesPage({
  ...
  const [categories, locations, rawProducts, settingRow] = await Promise.all([
  ...
  // Packing name + factor live on the Unit master; flatten them for the panels.
  const products = rawProducts.map((p) => ({ ...p, unitConversions: packingViews(p.unitConversions) }));
